...
class designer_workControl extends BaseSellerControl {
    ...
    public function designer_work_listOp() {
        ...
        $condition=array('sn_store_id' => intval($_SESSION['store_id']));
        $designers = $model_designer->getDesignerList($condition);
    ...
    public function designer_work_saveOp() {
        ...
        $sn_info = array(
            ...
            'sn_category' => $_POST['category'],
            'sn_style' => $_POST['style'],
        ...
        $model_designer->updateDesignerWorkCount(array('designer_id'=>intval($_POST['designer_id'])));
