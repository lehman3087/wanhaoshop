      ...
      <tbody>
        <tr class="noborder" id="tr_pic_type" style="display:none">
          <td class="vatop rowform"><ul>
              <li>
                <label>
                  <input name="pic_type" id="pic_type_1" type="radio" value="1" <?php if ($output['info']['pic_type'] ==1 ) echo 'checked="checked"';?>>
              ...
              <li>
                <label>
                  <input type="radio" name="pic_type" id="pic_type_3" value="3" <?php if ($output['info']['rec_app'] ==1) echo 'checked="checked"';?>>
                 商户报名</label>
              </li>
            </ul></td>
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><?php echo $lang['rec_ps_image_width'];?>:
            <input type="text" style="width:30px" name="rwidth" value="<?php echo $output['info']['pic_width'];?>">
            px&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $lang['rec_ps_image_height'];?>:
            <input type="text" value="<?php echo $output['info']['pic_height'];?>" style="width:30px" name="rheight">
            px</td>
        ...
        <tr>
         ...
         <tr>
            <td class="vatop rowform" style="width: 700px">
                ...
                <label>
                  <input type="text" id="stime" name="stime" class="txt date" value="<?php echo date('Y-m-d',$output['info']['rec_start_time']);?>"></label>
              
              ～
                <label>
                   <input type="text" id="etime" name="etime" class="txt date" value="<?php echo date('Y-m-d',$output['info']['rec_stop_time']);?>">
                 </label>
              </td>
          <td class="vatop tips"></td>
        </tr>
        ...
        <tr>
              ...
              <li>
                <label>
                  <input name="rec_state"  type="radio" value="1" <?php if($output['info']['rec_state']==1){ echo "checked";} ?>>
                  有效</label>
              </li>
              <li>
                <label>
                  <input type="radio" name="rec_state" value="0" <?php if($output['info']['rec_state']==0){ echo "checked";}?>>
                  无效</label>
              </li>
            </ul></td>
            </tr>
...
$(function(){
	...
	$('#local_pic').show();
	$('#tr_pic_type').show();
	<?php if ($output['info']['pic_type']==0&& $output['info']['rec_app'] == 0){?>
		...
		<?php }?>
	<?php }elseif ($output['info']['pic_type'] == 1&& $output['info']['rec_app'] == 0){?>
		...
		<?php }?>		
	<?php }elseif ($output['info']['pic_type'] == 2 && $output['info']['rec_app'] == 0){?>
		$('#local_pic').hide();$('#remote_pic').show();
