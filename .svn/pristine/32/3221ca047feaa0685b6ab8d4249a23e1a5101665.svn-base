...
<div id="apply_company_info" class="apply-company-info">
  ...
  <form id="form_company_info" action="index.php?act=decoration_join&op=step2" method="post" enctype="multipart/form-data" >
  ...
  <div class="bottom"><a id="btn_apply_company_next" href="javascript:;" class="btn">下一步，填写财务信息</a></div>
</div>
