...
class p_bundlingModel extends Model {
     ...
     * @return array
     */
    public function getOpenBundlingCount($condition) {
     ...
     * @return array
     */
    public function getBundlingOpenList($condition, $field = '*', $order = 'bl_id desc', $limit = 0,$page=0) {
        $condition['bl_state'] = self::STATE1;
        return $this->getBundlingList($condition, $field, $order, $page, $limit);
    }
