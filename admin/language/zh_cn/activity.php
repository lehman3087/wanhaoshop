...
$lang['activity_index_qiang']		= '抢购';
$lang['activity_index_xszk']		= '限时折扣';
$lang['activity_index_mjs']		= '满即送';
$lang['activity_index_yhtz']		= '优惠套装';
...
$lang['rec_detail_index_tip1']	= '申请活动在没有审核或者审核失败的时候可以删除';
$lang['rec_detail_index_tip2']	= '本页申请广告位申请的显示规则是未审核先显示，排序越小越靠前显示';
$lang['rec_detail_index_tip3']	= '过期活动将不会在最重广告位显示，请慎重审核';
/**
 * 活动内容删除
 */
