...
<style type="text/css">
#top-banner, .public-top-layout, .head-app, .head-search-bar, .head-user-menu, .public-nav-layout, .nch-breadcrumb-layout, #faq {
      ...
      <form id="login_form" method="post" action="index.php?act=login&op=login"  class="bg">
        ...
        <dl>
          ...
          <dd style="min-height:54px;">
            <input type="text" class="text" placeholder="邮箱/用户名/已验证手机" autocomplete="off"  name="user_name" id="user_name" autofocus >
            <label></label>
          </dd>
        </dl>
        <dl>
