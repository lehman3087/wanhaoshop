...
$(function(){
    ...
    /* 商品图片ajax上传 */
    var url = SITEURL + '/index.php?act=designer_work&op=designer_work_image_upload';
    ...
    $('a[nctype="del"]').unbind().click(
        function() {
            ...
            $.getJSON('index.php?act=designer&op=dorp_img', {file_id : file_id, img_src : img_src}, function(data) {
            ...
            $.getScript(SHOP_RESOURCE_SITE_URL+"/js/work_upload.js");
        });
});
	...
	(
		{
			...
			success: function (data, status)
			{
				...
				}else
				{
					...
					$('img[nctype="'+id+'"]').attr('src',UPLOAD_SITE_URL+'/'+ATTACH_STORE+'/work/'+data.file_name);
