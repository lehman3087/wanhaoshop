...
$(function(){
    ...
    /* 商品图片ajax上传 */
    var url = SITEURL + '/index.php?act=designer&op=designer_image_upload';
    ...
    $('a[nctype="del"]').unbind().click(
        function() {
            ...
            $.getScript(SHOP_RESOURCE_SITE_URL+"/js/sn_upload.js");
        });
});
	...
	(
		{
			...
			success: function (data, status)
			{
				...
				}else
				{
					...
					$('img[nctype="'+id+'"]').attr('src',UPLOAD_SITE_URL+'/'+data.file_path).attr('width','200px');
