...
<div class="ncsc-form-default" nctype="signup" >
  ...
  <form method="post" action="index.php?act=store_sns&op=snsSignupEdit" id="normal_form1">
     <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="activity_id" value="<?php echo $output['activity']['activity_id'];?>" />
    <input type="hidden" name="activity_state" value="<?php echo $output['activity']['activity_state'];?>" />
    <input type="hidden" name="activity_type" value="<?php echo $output['activity']['activity_type'];?>" />

    <dl>
      <dt><i class="required">*</i>标题：</dt>
      <dd>
        <input class="w400 text" name="activity_title" type="text" id="activity_title" value="<?php echo $output['activity']['activity_title'];?>" maxlength="30"  />
        <span></span>
    ...
    <dl>
      ...
      <dd>
          <input id="activity_start_date" value="<?php echo date('Y-m-d',$output['activity']['activity_start_date']);?>" name="activity_start_date" type="text" class="text w130" /><em class="add-on"><i class="icon-calendar"></i></em><span></span>
    ...
    <dl>
      ...
      <dd>
          <input id="activity_end_date" value="<?php echo date('Y-m-d',$output['activity']['activity_end_date']);?>" name="activity_end_date" type="text" class="text w130"/><em class="add-on"><i class="icon-calendar"></i></em><span></span>
    ...
    <dl>
      ...
      <dd>
        <input class="w400 text" name="activity_location" type="text" id="activity_location" value="<?php echo $output['activity']['activity_location'];?>" maxlength="30"  />
        <span></span>
    ...
    <dl>
      ...
      <dd>
        <div class="ncsc-upload-thumb store-sns-pic">
          <p><img nctype="normal_img1" src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_ACTIVITY.'/'.$output['activity']['activity_banner']?>"/></p>
        ...
        <div class="handle">
          <div class="ncsc-upload-btn"> <a href="javascript:void(0);"><span>
            ...
            <a class="ncsc-btn mt5" nctype="get_img" href="index.php?act=store_goods_add&op=image_upload&cat=p"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" nctype="del_img" class="ncsc-btn ml5 mt5" style="display: none;"><i class="icon-circle-arrow-up"></i>关闭相册</a></div>
		...
		(
			{
				...
				success: function (data, status)
				{
					if(typeof(data.error) != 'undefind'){
						$('img[nctype="normal_img1"]').attr('src',data.image);
						$('#sns_image1').val(data.filename);
					}else{
						alert(data.error);
					}
				},
