...
//				'text' => '停车二维码',
//				'list' => array(
//					array('args'=>'party_add,party_barcode,party_barcode','text'=>'新建停车位'),
//				)
//			),
		),
);
...
if(C('decoration_issue')==1){
	...
	$arr['left'][] = array(
				...
				'text' => '装修',
				'list' => array(
					array('args'=>'settings_index,decoration,decoration',				'text'=>'装修设置'),
                                        array('args'=>'works,decoration,decoration',				'text'=>'装修需求管理'),
                                        array('args'=>'designer_works,decoration,decoration',				'text'=>'装修案例管理'),
//					array('args'=>'special_list,mb_special,mobile',				'text'=>'装修设置'),
