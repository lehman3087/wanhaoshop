...
<div class="alert alert-block alert-info mt10"> <strong><?php echo $lang['store_sns_type'].$lang['nc_colon'];?></strong>
  ...
  <label class="mr20">
    ...
    <label class="mr20">
    <input type="radio" name="sns_type" value="signup" id="sns_signup" class="vm mr5" />
    报名活动</label>
...
<div class="ncsc-form-default" nctype="normal" style=" display: none;">
  <form method="post" action="index.php?act=store_sns&op=store_sns_save" id="normal_form">
    <input type="hidden" name="type" value="2" />
      ...
      <dd>
        <input class="w400 text" name="title" type="text" id="activity_title" value="" maxlength="30"  />
        <span></span>
        ...
        <dd id="ncProductDetails">
         ...
         <dl>   <ul class="ui-tabs-nav" jquery1239647486215="2">
            ...
            <div id="panel-1" class="ui-tabs-panel" jquery1239647486215="4">
              <?php showEditor('g_body',$output['activity']['content'],'100%','480px','visibility:hidden;',"false",$output['editor_multimedia']);?>
              <div class="hr8">
                <div class="ncsc-upload-btn"> <a href="javascript:void(0);"><span>
                  <input type="file" hidefocus="true" size="1" class="input-file" name="add_album" id="add_news_album" multiple="multiple">
                  </span>
                  <p><i class="icon-upload-alt" data_type="0" nctype="add_album_i"></i>图片上传</p>
                  </a> </div>
                <a class="ncsc-btn mt5" nctype="show_desc2" href="index.php?act=store_album&op=pic_list&item=des"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a> <a href="javascript:void(0);" nctype="del_desc2" class="ncsc-btn mt5" style="display: none;"><i class=" icon-circle-arrow-up"></i>关闭相册</a> </div>
         ...
         <dl>   <ul class="ui-tabs-nav" jquery1239647486215="2">
            ...
            <div id="panel-2" class="ui-tabs-panel ui-tabs-hide" jquery1239647486215="5">
              ...
              <div class="ncsc-mobile-edit-area" nctype="mobile_editor_area">
                ...
                <div class="ncsc-mea-text" nctype="mea_txt" style="display: none;">
                  <p id="meat_content_count" class="text-tip"></p>
                  <textarea class="textarea valid" style="font-size:12px" nctype="meat_content">萨芬大赛的发生地</textarea>
                  <div class="button"><a class="ncsc-btn ncsc-btn-blue" nctype="meat_submit" href="javascript:void(0);">确认</a><a class="ncsc-btn ml10" nctype="meat_cancel" href="javascript:void(0);">取消</a></div>
                  <a class="text-close" nctype="meat_cancel" href="javascript:void(0);">X</a>
                </div>
              </div>
...
<!--              <dl  style="display: none">
     ...
     <dl>
      <dt><i class="required">*</i>是否推荐<?php echo $lang['nc_colon'];?></dt>
      <dd>
          是：<input id="" name="activity_rec" type="radio" class="text w130"/>
          否：<input id="" name="activity_rec" type="radio" checked="" class="text w130"/>
      </dd>
    </dl>
