  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="nscs-table-handle">
       <?php if (!checkbid(array('bid_dc_id'=>$_SESSION['store_id'],'bid_work_id'=>$val['dw_id']))) {?>
        <span class="tip" title=""><a href="<?php if ($val['is_virtual'] ==1 ) {echo 'javascript:void(0);';} else {echo urlShop('store_goods_online', 'add_gift', array('commonid' => $val['goods_commonid']));}?>" class="btn-orange-current"><i class="icon-lock"></i>
        <p>锁定</p>
        </a></span>
