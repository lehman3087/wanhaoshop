  ...
  <table class="ncsc-default-table" >
    ...
    <tbody>
      ...
      <tr class="bd-line">
          <td>
              <div class="" >
                  <img class="show_image"  src="<?php echo rec_thumb($v['rec_img'], 60);?>">
                     <div class="type-file-preview"><img src="<?php echo rec_thumb($v['rec_img']);?>" onload="javascript:DrawImage(this,500,500);"></div>
...
<!--              <div class="goods-thumb"><a href="javascript:void(0);" target="_blank"><img src="<?php echo cthumb($po['img'], 240, $_SESSION['store_id']);?>"></a></div>-->
            <dl class="goods-info">
              <dt>
                ...
                <input type="hidden"  value="<?php echo $po['type'];?>" class="vm" name="item_cate[<?php echo $po['id'];?>]"/>
                <input type="hidden"  value="<?php echo $po['name'];?>" class="vm" name="item_name[<?php echo $po['id'];?>]"/>
