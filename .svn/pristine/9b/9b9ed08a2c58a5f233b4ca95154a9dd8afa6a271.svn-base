...
<!--              <option value="1" <?php if($output['activity']['activity_type']=='1'){?>selected<?php }?>><?php echo $lang['activity_index_goods'];?></option>
              <option value="10" <?php if($output['activity']['activity_type']=='10'){?>selected<?php }?>>报名活动</option>-->
              <option value="11" <?php if($output['activity']['activity_type']=='11'){?>selected<?php }?>>商户活动</option>
            </select></td>
        ...
        <tr>
            ...
            <td id="ncProductDetails" style="width:75%">
          <div class="tabs">
            ...
            <div id="panel-1" class="ui-tabs-panel" jquery1239647486215="4">
              ...
              <div class="hr8">
                ...
                <a class="ncsc-btn mt5" nctype="show_desc" href="<?php echo ADMIN_SITE_URL; ?>/index.php?act=album&op=pic_list&item=des"><i class="icon-picture"></i>打开相册</a> <a href="javascript:void(0);" nctype="del_desc" class="ncsc-btn mt5" style="display: none;"><i class=" icon-circle-arrow-up"></i>关闭相册</a> </div>
              <p id="des_demo"></p>
            </div>
