           ...
           <?php foreach ($category as $key => $value) { ?>
        	<tr id="row_<?php echo $key ?>">
        		...
        		<td class="align-left">
                            ...
                            －
                            <input type="text" name="category[]" value="<?php echo $value; ?>" class="w60" nc_type="verify" /></td>
        	</tr>
           <?php } ?>
        	<tr id="row">
        		
        		<td class="align-left">+<input type="text" name="category[]"  value="" class="w60" /></td>
        	</tr>
        </tbody>
        <tfoot>
        	<tr>
