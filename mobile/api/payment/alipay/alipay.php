...
class alipay {
	...
	/************************************************************/
		...
		//$this->notify_url		= MOBILE_SITE_URL.'/api/payment/alipay/notify_url.php';
                $this->notify_url = 'http://'.$_SERVER['SERVER_NAME'].'/mobile/index.php?act=payment&op=notify';
		//$this->call_back_url	= MOBILE_SITE_URL.'/api/payment/alipay/call_back_url.php';
                $this->call_back_url = 'http://'.$_SERVER['SERVER_NAME'].'/mobile/index.php?act=payment&op=return';
		...
		$para_token = array(
                                ...
                                "payment_type"=>1,
                                "sign_type"=>trim($this->alipay_config['sign_type']),
