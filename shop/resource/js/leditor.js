...
$(function(){
    ...
    //报名活动上传
    $('#add_activity_album').fileupload({
        dataType: 'json',
        url: SITEURL+'/index.php?act=store_sns&op=image_upload',
    ...
    $('#add_news_album').fileupload({
        ...
        //报名活动编辑器打开关闭上传图片
    $('a[nctype="show_desc2"]').unbind().ajaxContent({
        event:'click', //mouseover
        loaderType:"img",
        loadingMsg:SHOP_TEMPLATES_URL+"/images/loading.gif",
        target:'#des_demo2'
        ...
        $(this).hide();
        $('a[nctype="del_desc2"]').show();
    });
    
    $('a[nctype="del_desc2"]').click(function(){
        $('#des_demo1').html('');
        $(this).hide();
        $('a[nctype="show_desc2"]').show();
    });
