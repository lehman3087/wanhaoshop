...
<div class="page">
  <form method="post" name="form1" id="form1" action="<?php echo urlAdmin('decoration', 'dw_verify');?>">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
          <tr>
              <td colspan="1" class="required"><label>标题:</label><?php echo $output['dw']['dw_name']; ?></td>
              
          </tr>
          <tr>
              <td colspan="1" class="required"><label>创建时间:</label><?php echo @date('Y-m-d',$output['dw']['dw_add_time']);?></td>
        </tr>
          <tr>
              <td colspan="2" class="required"><label>预算:</label><?php echo $output['dw']['dw_budget']; ?></td>
          </tr>
          <tr>
              <td colspan="2" class="required"><label>用户:</label><?php echo $output['dw']['dw_user_id']; ?></td>
          </tr>
          <tr>
              <td colspan="2" class="required"><label>预算:</label><?php echo $output['dw']['dw_budget']; ?></td>
          </tr>
