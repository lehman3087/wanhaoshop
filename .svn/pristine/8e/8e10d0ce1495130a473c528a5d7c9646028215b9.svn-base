...
class designer_workModel extends Model{
    ...
    public function delDwCommon($condition,$reason) {
       ...
       //  $condition=$this->_dealCondition($condition);
       // $condition = $this->_getRecursiveClass($condition);
         $field='designer_work.sn_category as dw_category,designer_work.sn_house_type as dw_house_type,designer_work.sn_style ,designer_work.sn_work_pic,designer_work.id,designer_work.sn_m_pic,designer_work.sn_name,designer_work.sn_collect as sn_collection_count,designer_work.sn_share_count,designer.sn_head';
