...
if (C('barcode_isuse') !== NULL){
    
    
	$_limit[] = array('name'=>$lang['nc_barcode'], 'child'=>array(
        array('name'=>$lang['nc_party_barcodemanage'], 'op'=>'party_barcode','act'=>'index'),
	array('name'=>$lang['nc_party_add'], 'op'=>'party_barcode', 'act'=>'party_add'),
	array('name'=>$lang['nc_party_delete'], 'op'=>'party_barcode', 'act'=>'del'),
        array('name'=>$lang['nc_party_ajax'], 'op'=>'party_barcode', 'act'=>'ajax')
	));
}
if(C('decoration_issue')!== NULL){
    
    $_limit[] = array('name'=>'装修', 'child'=>array(
        array('name'=>'装修设置', 'op'=>'decoration','act'=>'settings_index'),
	array('name'=>'装修需求管理', 'op'=>'decoration', 'act'=>'works'),
	array('name'=>'装修案例管理', 'op'=>'decoration', 'act'=>'designer_works')
	));
}
